...
if __name__ == '__main__':
    ...
    parser.add_argument('--img-path', type=str,default='/home/csx/data/allweather/input')
    ...
    #depth_anything = DepthAnything.from_pretrained('LiheYoung/depth-anything-small-hf').to(DEVICE).eval()
