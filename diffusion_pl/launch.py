...
import torch
from models_prompt.modules.utils.file_io import PathManager
from models_prompt.modules.utils import logging
from models_prompt.modules.utils.distributed import get_rank, get_world_size
...
def default_argument_parser():
    ...
    parser.add_argument(
        "--config-file", default="/home/csx/data/cvpr_24/configs/prompt/cub.yaml", metavar="FILE", help="path to config file")
    parser.add_argument(
